 ...
 */
@Service
public class X50HedgeStrategyFixed3MidRangeSTDSteady implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_3_MIDRANGE_STD_STEADY_50X);
        cfg.setPositionAmountUSD(new BigDecimal("388.8"));
