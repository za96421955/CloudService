 ...
 */
@Service
public class X20HedgeStrategyFixed2MidRangeSTDMediocre implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_2_MIDRANGE_STD_MEDIOCRE_20X);
        cfg.setPositionAmountUSD(new BigDecimal("216"));
