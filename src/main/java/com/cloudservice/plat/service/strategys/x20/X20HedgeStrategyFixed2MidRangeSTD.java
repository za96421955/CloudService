 ...
 */
@Service
public class X20HedgeStrategyFixed2MidRangeSTD implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_2_MIDRANGE_STD_20X);
        cfg.setSteadyAmountUSD(new BigDecimal("648"));
        cfg.setMediocreAmountUSD(new BigDecimal("216"));
        cfg.setRadicalAmountUSD(new BigDecimal("72"));
