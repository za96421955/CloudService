 ...
 */
@Service
public class X50HedgeStrategyFixed2MidRangeSTDSteady implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_2_MIDRANGE_STD_STEADY_50X);
        cfg.setPositionAmountUSD(new BigDecimal("259.2"));
