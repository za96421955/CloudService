 ...
 */
@Service
public class X50HedgeStrategyFixed4MidRangeSTDSteady implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_4_MIDRANGE_STD_STEADY_50X);
        cfg.setPositionAmountUSD(new BigDecimal("518.4"));
