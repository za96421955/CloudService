 ...
 */
@Service
public class X20HedgeStrategyFixed3MidRangeSTDSteady implements StrategyAPI<HedgeConfig> {

    @Override
    public HedgeConfig getStrategy() {
        HedgeConfig cfg = new HedgeConfig(StrategyTypeEnum.FIXED_3_MIDRANGE_STD_STEADY_20X);
        cfg.setPositionAmountUSD(new BigDecimal("972"));
